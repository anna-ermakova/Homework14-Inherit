public class Main {
    public static void main(String[] args) {
        ...
        Car hyundai = new Car("Hyundai", "Avante", 2016,"Южная Корея", "оранжевый", 180, 1.6,
                "автоматическая", "седан", "у001ук161", 5, "зимняя");
        ...
        System.out.println();
        Bus liaz = new Bus("Лиаз", "ЛиАЗ-5256", 2011, "Россия", "желтый", 140);
        Bus paz = new Bus("ПАЗ", "Вектор", 2000, "Россия", "белый", 180);
        Bus gaz = new Bus("Газ", "Газель Next A63R42", 2020, "Россия", "голубой", 200);
